...
def get_service_schemas() -> dict[str, vol.Schema]:
    ...
    schemas = {
        ...
        "get_connection_status": vol.Schema({vol.Required(ATTR_DEVICE_ID): DEVICE_ID_SELECTOR}),
        ...
        "test_connection": vol.Schema({vol.Required(ATTR_DEVICE_ID): DEVICE_ID_SELECTOR}),
        "clear_error_history": vol.Schema({vol.Required(ATTR_DEVICE_ID): DEVICE_ID_SELECTOR}),
        # NEW HTTP-based control services (Direct setFunctionManually API)
        "control_pump_http": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "control_heater_http": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "control_backwash_http": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "set_dosing_max_daily": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "configure_temp_rule": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "configure_analog_rule": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "configure_switching_rule": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "configure_timer_rule": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
                ...
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
                        vol.Optional(ATTR_DEVICE_ID): DEVICE_ID_SELECTOR,
                        vol.Required("relay_id"): vol.All(vol.Coerce(int), vol.Range(min=1, max=8)),
                        vol.Optional("action"): vol.In(["on", "off", "toggle"]),
                        vol.Optional("state"): vol.All(vol.Coerce(int), vol.Range(min=0, max=6)),
                        vol.Optional("duration", default=0): vol.All(
        ...
        "configure_sensor_calibration": vol.Schema(
            vol.All(
                vol.Schema(
                    {
                        vol.Optional(ATTR_ENTITY_ID): cv.entity_ids,
        ...
        "get_calibration_status": vol.Schema({vol.Required(ATTR_DEVICE_ID): DEVICE_ID_SELECTOR}),
        "get_backwash_status": vol.Schema({vol.Required(ATTR_DEVICE_ID): DEVICE_ID_SELECTOR}),
        "get_system_update_status": vol.Schema({vol.Required(ATTR_DEVICE_ID): DEVICE_ID_SELECTOR}),
    }

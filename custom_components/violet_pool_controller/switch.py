...
class VioletDeviceSensor(CoordinatorEntity, SensorEntity):
    ...
    def __init__(self, coordinator, key, icon, config_entry):
        ...
        device_id = self._config_entry.data.get('device_id', 'XX')  # Get device ID or default to 'XX'
        self._attr_name = f"Violet {device_id} {self._key}"
...
SENSORS = [
    ...
    {"name": "System CPU Temperature", "key": "SYSTEM_cpu_temperature", "icon": "mdi:thermometer"},
    {
        ...
        "key": "SYSTEM_carrier_cpu_temperature",
        "icon": "mdi:thermometer"
    },
    {
        "name": "System Dosage Module CPU Temperature",
        "key": "SYSTEM_dosagemodule_cpu_temperature",
        "icon": "mdi:thermometer"
    },
    ...
    {
        "name": "Chlorine Daily Dosing Amount",
        "key": "DOS_1_CL_DAILY_DOSING_AMOUNT_ML",
        "icon": "mdi:flask"
    },
    {
        "name": "Chlorine Total Can Amount",
        "key": "DOS_1_CL_TOTAL_CAN_AMOUNT_ML",
        "icon": "mdi:flask"
    },
    {
        "name": "ELO Daily Dosing Amount",
        "key": "DOS_2_ELO_DAILY_DOSING_AMOUNT_ML",
        "icon": "mdi:flask"
    },
    {
        "name": "ELO Total Can Amount",
        "key": "DOS_2_ELO_TOTAL_CAN_AMOUNT_ML",
        "icon": "mdi:flask"
    },
    {
        "name": "pH-minus Daily Dosing Amount",
        "key": "DOS_4_PHM_DAILY_DOSING_AMOUNT_ML",
        "icon": "mdi:flask"
    },
    {
        "name": "pH-minus Total Can Amount",
        "key": "DOS_4_PHM_TOTAL_CAN_AMOUNT_ML",
        "icon": "mdi:flask"
    },
    ...
    {
        "name": "System Carrier Alive Count",
        "key": "SYSTEM_carrier_alive_count",
        "icon": "mdi:alert-circle"
    },
    {
        "name": "System EXT1 Module Alive Count",
        "key": "SYSTEM_ext1module_alive_count",
        "icon": "mdi:alert-circle"
    },
    {
        "name": "System Dosage Module Alive Count",
        "key": "SYSTEM_dosagemodule_alive_count",
        "icon": "mdi:alert-circle"
    },

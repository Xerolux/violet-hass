...
**Current Version**: `1.0.6-alpha.2` (defined in `manifest.json` and `const.py`)
...
- **External API package** (`violet-poolController-api==0.0.16` on PyPI) - The HTTP client and low-level utilities are **not** in this repo; they ship as an external package. Provides:

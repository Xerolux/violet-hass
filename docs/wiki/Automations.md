  ...
  - alias: "Pool: pH too low – dose pH+"
    ...
    action:
      ...
      - service: notify.mobile_app_phone
        data:
          title: "Pool pH Alert"
          message: "pH was too low ({{ states('sensor.violet_pool_controller_ph_value') }}). pH+ was dosed."
    ...
    action:
      - service: notify.mobile_app_phone
        data:
          title: "Pool is warm!"
          message: >
            Water temperature: {{ states('sensor.violet_pool_controller_pool_temperature') }}°C
    ...
    action:
      - service: notify.mobile_app_phone
        data:
          ...
          message: >
            Water: {{ states('sensor.violet_pool_controller_pool_temperature') }}°C
            pH: {{ states('sensor.violet_pool_controller_ph_value') }}
            ORP: {{ states('sensor.violet_pool_controller_orp_value') }} mV
            Chlorine: {{ states('sensor.violet_pool_controller_chlorine_level') }} mg/l
            Pump: {{ states('switch.violet_pool_controller_pump') }}
            Heater: {{ states('climate.violet_pool_controller_heater') }}
```
    ...
    action:
      - service: notify.mobile_app_phone
        data:
          ...
          message: >
            pH Value: {{ states('sensor.violet_pool_controller_ph_value') }}
            Dose pH+ immediately!
